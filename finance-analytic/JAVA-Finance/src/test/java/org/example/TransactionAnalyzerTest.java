...
import org.example.transaction_tools.analyzers.TransactionAnalyzer;
...
public class TransactionAnalyzerTest {
    ...
    public void testCalculateTotalBalanceTest() {
        ...
        softly.assertThat(analyzer.calculateTotalBalance())
                .as("Розрахунок загального балансу")
                .isEqualTo(200.0);
    ...
    public void getTopExpenseCategoryTest(){
        ...
        Transaction transaction3 = new Transaction("01-02-2023", 150.0, "Дохід");
        Transaction transaction4 = new Transaction("02-02-2023", 150.0, "Дохід");
        Transaction transaction5 = new Transaction("02-02-2023", -250.0, "Подарунки");
        Transaction transaction6 = new Transaction("03-02-2023", -100.0, "Продукти");
        Transaction transaction7 = new Transaction("03-02-2023", -150.0, "Ліки");
        Transaction transaction8 = new Transaction("04-02-2023", -250.0, "Ліки");
