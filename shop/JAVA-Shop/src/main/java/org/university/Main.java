...
import org.university.exceptions.ProductNotFoundException;

import java.util.Scanner;

public class Main {
    public static void main(String[] args) {
        Category computers = new Category(1, "Ком'ютери");
        Category smartphones = new Category(2, "Смартфони");
        Category accessories = new Category(3, "Аксесуари");

        Product product1 = new Product(1, "Ноутбук", 19999.99, "Високопродуктивний ноутбук для роботи та ігор", computers);
        ...
        Product product4 = new Product(4, "Чохол", 299.00, "Чохол для телефону", accessories);
